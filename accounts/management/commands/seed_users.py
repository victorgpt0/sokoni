...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            self.style.SUCCESS('User seeding completed successfully!')
        )
    ...
    def create_users(self, count):
        ...
        first_names = [
            # Kenyan names
            'Wanjiku', 'Kamau', 'Atieno', 'Ochieng', 'Njeri', 'Mwangi', 'Akinyi', 'Otieno',
            'Wanjiru', 'Kariuki', 'Adhiambo', 'Kipchoge', 'Nyawira', 'Kiptoo', 'Wambui', 'Koech',
            'Awino', 'Rotich', 'Wairimu', 'Langat', 'Nekesa', 'Bett', 'Mumbua', 'Tanui',
            # International names
            'John', 'Sarah', 'Michael', 'Emily', 'David', 'Jessica', 'Christopher', 'Ashley',
            'Daniel', 'Amanda', 'Matthew', 'Lisa', 'Andrew', 'Michelle', 'Joshua', 'Jennifer',
            'Anthony', 'Elizabeth', 'Kevin', 'Nicole', 'Brian', 'Stephanie', 'Mark', 'Helen'
        ]
        
        last_names = [
            # Kenyan surnames
            'Wanjiku', 'Kamau', 'Ochieng', 'Otieno', 'Mwangi', 'Kariuki', 'Kipchoge', 'Kiptoo',
            'Koech', 'Rotich', 'Langat', 'Bett', 'Tanui', 'Cheruiyot', 'Kiprotich', 'Kemboi',
            'Mutua', 'Mwenda', 'Nyong\'o', 'Odinga', 'Ruto', 'Gachagua', 'Waiguru', 'Kidero',
        ...
        kenyan_prefixes = ['254701', '254702', '254703', '254704', '254705', '254706', '254707', 
                          '254708', '254709', '254710', '254711', '254712', '254713', '254714',
                          '254715', '254716', '254717', '254718', '254719', '254720', '254721',
                          '254722', '254723', '254724', '254725', '254726', '254727', '254728']
    ...
    def create_addresses(self, users):
        ...
        kenyan_cities = [
            ...
            'Homa Bay', 'Bungoma', 'Voi', 'Wajir', 'Isiolo', 'Narok', 'Nanyuki', 'Kajiado'
        ]
        
        nairobi_areas = [
            'Westlands', 'Karen', 'Kilimani', 'Lavington', 'Parklands', 'Kileleshwa',
            'South B', 'South C', 'Runda', 'Muthaiga', 'Spring Valley', 'Riverside',
            'Hurlingham', 'Kiambu Road', 'Ngong Road', 'Thika Road', 'Mombasa Road'
        ]
        
        mombasa_areas = [
            'Nyali', 'Bamburi', 'Shanzu', 'Tudor', 'Changamwe', 'Likoni', 'Old Town',
            'Mvita', 'Kisauni', 'Jomba'
        ]
        ...
        street_names = [
            ...
            'Valley Road', 'Riverside Drive', 'Mama Ngina Street', 'Haile Selassie Avenue'
        ]
        
        kenyan_counties = [
            'Nairobi', 'Mombasa', 'Kisumu', 'Nakuru', 'Uasin Gishu', 'Kiambu',
            'Kilifi', 'Trans Nzoia', 'Garissa', 'Kakamega', 'Machakos', 'Meru',
            'Nyeri', 'Kericho', 'Embu', 'Migori', 'Homa Bay', 'Bungoma'
        ]
            ...
            for i in range(num_addresses):
                ...
                try:
                    address = CustomerAddress.objects.create(
                        ...
                        company=f"{random.choice(['', 'Safaricom', 'Equity Bank', 'KCB', 'Co-op Bank', 'EABL', 'Kenya Airways'])}" if random.random() < 0.3 else "",
                    ...
                    self.stdout.write(
                        self.style.ERROR(f'Error creating address for {user.username}: {str(e)}')
                    )
                    continue
