...
urlpatterns = [
    # Payment processing
    path('process/<str:order_number>/', views.process_payment_view, name='process_payment'),
    ...
    path('failed/<str:order_number>/', views.payment_failed_view, name='payment_failed'),
