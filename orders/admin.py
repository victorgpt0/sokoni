...
class OrderAdmin(admin.ModelAdmin):
    ...
    search_fields = ('order_number', 'customer__user__username', 'customer__user__email', 'tracking_number')
    readonly_fields = ('order_number', 'created_at', 'updated_at', 'created_by', 'updated_by',)
...
class OrderItemAdmin(admin.ModelAdmin):
    list_display = ('order_number', 'product_name', 'product_price', 'quantity', 'total_price', 'created_at')
    list_filter = ('created_at',)
    search_fields = ('order__order_number', 'product__name', 'product_name')
    readonly_fields = ('total_price', 'created_at', 'created_by', 'updated_by', 'updated_at',)
