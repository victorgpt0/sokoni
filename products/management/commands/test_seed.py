...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(f'Category: {category.name} ({"created" if created else "existing"})')
        ...
        self.stdout.write(self.style.SUCCESS('✅ Basic seeding test completed successfully!'))
