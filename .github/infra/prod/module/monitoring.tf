...
output "amp_remote_write_url" {
  value = "https://aps-workspaces.${var.aws_region}.amazonaws.com/workspaces/${aws_prometheus_workspace.amp.id}/api/v1/remote_write"
}
output "grafana_endpoint" {
  value = aws_grafana_workspace.amg.endpoint
}
output "amp_vpc_endpoint_dns" {
  value = aws_vpc_endpoint.aps_workspace.dns_entry
}
output "amp_task_role_arn" {
  value = aws_iam_role.amp_task_role.arn
}
