...
class CartAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("customer", "session_key")}),
        ("Summary", {"fields": ("total_items", "subtotal")}),
        (
            "Timestamps",
    ...
    def cart_owner(self, obj):
        ...
        return format_html(
            ...
            (
                obj.session_key[:20] + "..."
                if obj.session_key and len(obj.session_key) > 20
...
class CartItemAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("cart", "product", "quantity")}),
    ...
    def get_queryset(self, request):
        return (
            ...
            .select_related("cart__customer__user", "product")
        )
