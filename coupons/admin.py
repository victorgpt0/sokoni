...
class CouponAdmin(admin.ModelAdmin):
    list_display = ('code', 'discount_display', 'minimum_amount', 'usage_display', 'status_display', 'valid_period')
    list_filter = ('discount_type', 'is_active', 'created_at', 'valid_from', 'valid_to')
    search_fields = ('code',)
    readonly_fields = ('used_count', 'created_at', 'is_valid', 'created_by', 'updated_by', 'updated_at')
