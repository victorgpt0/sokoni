...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for coupon_data in coupons_data:
            ...
            valid_from = now - timedelta(days=random.randint(0, 30))  # Some already started
            ...
            try:
                coupon = Coupon.objects.create(
                    ...
                    used_count=random.randint(0, min(coupon_data['usage_limit'] // 3, 50)),  # Some usage
                ...
                created_count += 1
                self.stdout.write(f'Created coupon: {coupon.code} ({coupon.get_discount_type_display()})')
                
            except Exception as e:
                self.stdout.write(
                    self.style.ERROR(f'Error creating coupon {coupon_data["code"]}: {str(e)}')
                )
                continue
    ...
    def create_random_coupons(self):
        ...
        random_codes = [
            'SAVE5NOW', 'DEAL10', 'LUCKY15', 'BONUS20', 'EXTRA25', 'SUPER30',
            'QUICK5', 'FAST10', 'RUSH15', 'SPEED20', 'TURBO25', 'ZOOM30'
        ]
